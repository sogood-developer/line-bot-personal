...
class multiGetLastReadMessageIds_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    self.chatIds = []
                    (_etype1626, _size1623) = iprot.readListBegin()
                    for _i1627 in range(_size1623):
                        _elem1628 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.chatIds.append(_elem1628)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.chatIds is not None:
            ...
            for iter1629 in self.chatIds:
                oprot.writeString(iter1629.encode('utf-8') if sys.version_info[0] == 2 else iter1629)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1634 in range(_size1630):
                        _elem1635 = LastReadMessageIds()
                        _elem1635.read(iprot)
                        self.success.append(_elem1635)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
